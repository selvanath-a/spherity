...
describe('CredentialController', () => {
  ...
  describe('getCredentials', () => {
    it('should return list of credentials', async () => {
      ...
      expect(credentialService.getCredentialsList).toHaveBeenCalledWith(
        'test-wallet',
      );
      expect(result).toEqual([mockCredential]);
    });
  ...
  describe('getCredential', () => {
    it('should return a single credential', async () => {
      const result = await controller.getCredentialbyId(
        'test-wallet',
        'test-id',
      );
  ...
  describe('verifyCredentialWithId', () => {
    it('should verify credential by ID', async () => {
      const result = await controller.verifyCredentialWithId(
        'test-wallet',
        'test-id',
      );

      expect(credentialService.verifyCredentialWithId).toHaveBeenCalledWith(
        'test-wallet',
        'test-id',
      );
  ...
  describe('deleteCredential', () => {
    it('should delete a credential and return confirmation', async () => {
      const result = await controller.deleteCredential(
        'test-wallet',
        'test-id',
      );
